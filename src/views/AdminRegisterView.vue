      ...
      <div class="form-panel">
        <div class="auth-card">
          ...
          <div class="auth-header">
            ...
            <h2 class="auth-title">Registrasi Admin</h2>
            <p class="auth-subtitle">Buat akun admin baru untuk mengakses panel</p>
          </div>

          <transition name="alert-slide">
            <div v-if="errorMessage" class="alert alert-danger" key="err">
          ...
          <transition name="alert-slide">
            <div v-if="successMessage" class="alert alert-success" key="ok">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" style="flex-shrink:0">
          ...
          <form @submit.prevent="handleRegister" class="auth-form">
            <div class="form-group">
              ...
              <div class="input-wrap">
                ...
                <input type="text" v-model="form.name" placeholder="Nama lengkap admin" required />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="input-wrap">
                ...
                <input type="email" v-model="form.email" placeholder="admin@tugu.com" required />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="input-wrap">
                ...
                <input :type="showPass ? 'text' : 'password'" v-model="form.password" placeholder="••••••••" required minlength="6" />
            ...
            <button type="submit" class="btn-submit" :disabled="loading">
              ...
              <span v-else>Registrasi Admin</span>
            </button>

            <!-- Separator "Atau masuk dengan" -->
            <div class="sso-separator">
              <span class="sso-separator-text">Atau daftar dengan</span>
            </div>
  ...
  try {
    ...
    if (err.response?.data) {
      ...
      errorMessage.value = d.errors
        ? d.errors[Object.keys(d.errors)[0]][0]
...
.alert-success { background: rgba(132,204,22,0.12); color: #a3e635; border: 1px solid rgba(132,204,22,0.25); }
